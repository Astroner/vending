        ...
        <div className={cn.root} >
            ...
            <div className={cn.container}>
                {props.value.map((slot, i) => (
                    <SlotCard key={slot.slot} index={i} maxItems={props.maxItems} info={slot} onChange={props.onSlotChange} onDelete={props.onSlotDelete}  />
                ))}
                {props.canAdd && (
            ...
            <div className={cn['submit-container']}>
                <button className={cn.submit} onClick={() => props.onSubmit(props.value)}>
                    Submit
                </button>
            </div>
        </div>
